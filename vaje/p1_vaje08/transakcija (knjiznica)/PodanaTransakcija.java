...
public class PodanaTransakcija {
	...
	private PodanaTransakcija(int clan, int naslov, VrstaTransakcije vrsta, GregorianCalendar gc) {
		this(clan, naslov, vrsta, gc, Status.OK);
	}
	
	private PodanaTransakcija(int clan, int naslov, VrstaTransakcije vrsta, GregorianCalendar gc, Status status) {
		this.clan = clan;
		this.naslov = naslov;
	...
	public static PodanaTransakcija createTransakcija(int clan, int naslov, VrstaTransakcije vrsta, GregorianCalendar gc, Status status) {
		if (clan < 0 || naslov < 0 || gc == null || vrsta == null)
			return null;
		return new PodanaTransakcija(clan, naslov, vrsta, gc, status);
	}
