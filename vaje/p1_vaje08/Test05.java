...
public class Test05 {
	...
	public static void main(String[] args) {
		...
		double avgDni = knjiznica.povprecjeIzposojDni();
		System.out.printf("%nPovprecje izposoje: %5.2f dni%n", avgDni);
		
		int medDni = knjiznica.medianaIzposojDni();
		System.out.printf("%nMediana izposoje: %d dni%n", medDni);
	}
}