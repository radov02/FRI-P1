...
public class Test07 {
    ...
    public static void main(String[] args) {
        int stClanov = 3;
        int stNaslovov = 5;
        OsnovnaKnjiznica knjiznica = new OsnovnaKnjiznica(stClanov, stNaslovov, 10);
    ...
    private static void izpisiPosojeneIzvode(OsnovnaKnjiznica knjiznica, int stNaslovov) {
