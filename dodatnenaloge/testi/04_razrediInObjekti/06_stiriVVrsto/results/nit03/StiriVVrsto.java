...
public class StiriVVrsto {
    ...
    public int najdaljseZaporedje(int igralec)
    {
        ...
        for(int i = 0; i < this.polje.length; i++){
            for(int j = 0; j < this.polje[i].length; j++){
                if(this.polje[i][j] == igralec){
                    int k = j;
                    while(k < this.polje[i].length && this.polje[i][k] == igralec){
                        k++;
                    }
        ...
        //             int k = i;
        //             while((k + i) < this.polje[i].length && this.polje[j][k] == igralec){
        //                 k++;
        //             }
        ...
        //             int k = i;
        //             int l = j;
        //             while((k + i) < this.polje.length && (l +  < this.polje[i].length && this.polje[k][l] == igralec){
        //                 k++;
        //                 l++;
        //             }
    ...
    public void izpisPolja(){
        for(int i = this.polje.length - 1; i >= 0; i--){
            for(int j = 0; j < this.polje[i].length; j++){
                System.out.print(this.polje[i][j] + " ");
            }
            System.out.println();
        }
        System.out.println("------------");
